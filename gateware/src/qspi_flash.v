            ...
            if (!sclk_phase) begin
               ...
               if (bit_cnt == 4'd1) begin
                  ...
                  if (byte_idx >= 4'd4) begin
                     case (byte_idx)
                       4'd4: captured[7:0]   <= {rx_shift[6:0], flash_miso};
                       4'd5: captured[15:8]  <= {rx_shift[6:0], flash_miso};
                       4'd6: captured[23:16] <= {rx_shift[6:0], flash_miso};
                       4'd7: captured[31:24] <= {rx_shift[6:0], flash_miso};
                     endcase
                  end
