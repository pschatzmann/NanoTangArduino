...
GW_SOURCES="picorv32.v sram8bit.v sram.v simpleuart.v uart_wrap.v reset.v systick.v tang_leds.v i2s.v pwm6.v spi_master.v od_gpio2.v gpio_bank.v ws2812b.v ws2812b_tgt.v extirq.v dma_engine.v qspi_flash.v int8_mac_lane.v dot_product_lane_array.v byte_interleave_ram.v dot_product_engine.v ai_accel_bus.v sdram.v sdram_bus.v gowin_rpll_sys.v top.v"
